...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12 mt-5 mx-auto">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Student Presentation Marks</h4>
                        ...
                        <table id="dataTableSession" class="text-center display ">
                            ...
                            <tbody>
                               ...
                               @foreach ($internship as $intern)
                                    ...
                                    @endphp
                                {{-- @if (strpos($prog->name, $findme) !== false) --}}
                                    <tr>
                                        @if (\Request::is('coordinator/feedback/presentation'))
                                        ...
                                        <td>
                                            ...
                                            @foreach($presentMarks as $pmark)
                                                @php
                                                $pTot = 0;
                                                    if ( $pmark->internship_id == $intern->id AND strpos($prog->name, $findme) !== false) {
