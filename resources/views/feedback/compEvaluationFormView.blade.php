    ...
    <div class="col-10 mt-5 mx-auto">
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-5">
                    <p><strong>Overall Marks</strong></p>
                    ...
                    <div class="table-responsive col-md-6">
                        <table class="table table-bordered text-center table-sm table-striped">
                            <tbody>
                                ...
                                <tr>
                                    <th>1</th>
                                    <td>{{ $markArr[0] + $markArr[1] + $markArr[2]  }}</td>
                                </tr>
                                <tr>
                                    <th>2</th>
                                    <td>{{ $markArr[3] + $markArr[4] + $markArr[5]  }}</td>
                                </tr>
                                <tr>
                                    <th>3</th>
                                    <td>{{ $markArr[6] + $markArr[7] + $markArr[8]  }}</td>
                                </tr>
                                <tr>
                                    <th>4</th>
                                    <td>{{ $markArr[9] + $markArr[10] + $markArr[11]  }}</td>
                                </tr>
                                <tr>
                                    <th>5</th>
                                    <td>{{ $markArr[12] + $markArr[13] + $markArr[14]  }}</td>
                                </tr>
                                <tr>
                                    <th>6</th>
                                    <td>{{ $markArr[15] + $markArr[16] + $markArr[17]  }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
