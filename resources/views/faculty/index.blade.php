...
@section('head')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/dw/dataTables-1.10.18.bootstrap4.min.css') }}">
...
<script>
    ...
    <script src="{{ asset('assets/dw/dataTables-1.10.18.bootstrap4.min.js') }}"></script>
