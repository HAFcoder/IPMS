                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('programme.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="code" placeholder="Enter programme code" required value="">
                        </div>

                        <div class="form-group">
                            <label for="example-text-input" class="col-form-label">Programme Name</label>
                            <input class="form-control" type="text" name="name" placeholder="Enter programme name" required value="">
                        </div>
